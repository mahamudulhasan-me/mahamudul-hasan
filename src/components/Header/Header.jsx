  ...
  return (
    <>
      <div className="fixed inset-0 container mx-auto border rounded-t-md text-s1  h-14 bg-p2  flex justify-between items-center  border-p4">
        {/* responsive menu  */}
        <div className="lg:w-[25%] z-50 w-full lg:pl-6 lg:px-0 px-10 flex justify-between items-center ">
          <span>_mahamudul-hasan</span>
        </div>

        {/* large device menu  */}
        <nav className="w-[calc(100vw-25%)] mx-auto border-l border-p4 h-full hidden lg:flex justify-between items-center">
