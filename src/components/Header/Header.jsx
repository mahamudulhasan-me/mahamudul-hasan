...
const Header = () => {
  return (
    <>
      <div className="fixed inset-0 container mx-auto border rounded-t-md text-s1  h-14 bg-p2  flex justify-between items-center  w-screen border-p4">
        <div className="w-[20.7%] z-50  lg:pl-6 lg:px-0 px-10 flex items-center ">
          <span>_mahamudul-hasan</span>
        </div>

        {/* large device menu  */}
        <nav className="w-[79.3%] mx-auto border-l border-p4 h-full hidden lg:flex justify-between items-center">
