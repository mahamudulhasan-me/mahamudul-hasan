...
const Experience = () => {
  return (
    <div id="experience" className="md:pt-20 md:pb-0 pb-10  space-y-2">
      <SectionHead icon={FaCode} title="Where I’ve Worked" />
      <MobileSectionHead icon={FaCode} title="Where I’ve Worked" />
      <Link
        href="#"
        className="flex md:flex-row flex-col items-start  md:gap-10 text-slate-300 group 0   hover:ease-in-out ease-linear hover:bg-navy-light p-4 rounded-md transition-all   lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg"
      >
